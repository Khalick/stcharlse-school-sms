...
router.post('/login', async (req, res): Promise<void> => {
  ...
  try {
    let matchedUser: { id: string; name: string; role: 'admin' | 'teacher' | 'student'; stream?: string; email?: string; assignments?: { className: string, subjectName: string }[]; xp_points?: number; current_streak?: number } | null = null;
